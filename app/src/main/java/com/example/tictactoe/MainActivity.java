...
public class MainActivity extends AppCompatActivity {
    ...
    public void box1(View view) {
        if(count > 0){
            if(flag == 0){
                iv1.setImageResource(R.drawable.gradient1);
                count --;
                flag = 1;
                c1 = 0;
                ...
                iv1.setImageResource(R.drawable.gradient2);
                count --;
                flag = 0;
                c1 = 1;
                ll1.setBackgroundResource(R.drawable.ic_baseline_gradient_24);
    ...
    public void box2(View view) {
        if(count > 0){
            if(flag == 0){
                iv2.setImageResource(R.drawable.gradient1);
                count --;
                flag = 1;
                c2 = 0;
                ll2.setBackgroundResource(R.drawable.gradient2);
                ...
                iv2.setImageResource(R.drawable.gradient2);
                count --;
                flag = 0;
                c2 = 1;
    ...
    public void box3(View view) {
        if(count > 0){
            if(flag == 0){
                iv3.setImageResource(R.drawable.gradient1);
                count --;
                flag = 1;
                c3 = 0;
                ll2.setBackgroundResource(R.drawable.gradient2);
                ...
                iv3.setImageResource(R.drawable.gradient2);
                count --;
                flag = 0;
                c3 = 1;
                ll1.setBackgroundResource(R.drawable.gradient1);
    ...
    public void box4(View view) {
        if(count > 0){
            if(flag == 0){
                iv4.setImageResource(R.drawable.gradient1);
                count --;
                flag = 1;
                c4 = 0;
                ll2.setBackgroundResource(R.drawable.gradient2);
                ...
                iv4.setImageResource(R.drawable.gradient2);
                count --;
                flag = 0;
                c4 = 1;
                ll1.setBackgroundResource(R.drawable.gradient1);
    ...
    public void box5(View view) {
        if(count > 0){
            if(flag == 0){
                iv5.setImageResource(R.drawable.gradient1);
                count --;
                flag = 1;
                c5 = 0;
                ll2.setBackgroundResource(R.drawable.gradient2);
                ...
                iv5.setImageResource(R.drawable.gradient2);
                count --;
                flag = 0;
                c5 = 1;
                ll1.setBackgroundResource(R.drawable.gradient1);
    ...
    public void box6(View view) {
        if(count > 0){
            if(flag == 0){
                iv6.setImageResource(R.drawable.gradient1);
                count --;
                flag = 1;
                c6 = 0;
                ll2.setBackgroundResource(R.drawable.gradient2);
                ...
                iv6.setImageResource(R.drawable.gradient2);
                count --;
                flag = 0;
                c6 = 1;
                ll1.setBackgroundResource(R.drawable.gradient1);
    ...
    public void box7(View view) {
        if(count > 0){
            if(flag == 0){
                iv7.setImageResource(R.drawable.gradient1);
                count --;
                flag = 1;
                c7 = 0;
                ll2.setBackgroundResource(R.drawable.gradient2);
                ...
                iv7.setImageResource(R.drawable.gradient2);
                count --;
                flag = 0;
                c7 = 1;
                ll1.setBackgroundResource(R.drawable.gradient1);
    ...
    public void box8(View view) {
        if(count > 0){
            if(flag == 0){
                iv8.setImageResource(R.drawable.gradient1);
                count --;
                flag = 1;
                c8 = 0;
                ll2.setBackgroundResource(R.drawable.gradient2);
                ...
                iv8.setImageResource(R.drawable.gradient2);
                count --;
                flag = 0;
                c8 = 1;
                ll1.setBackgroundResource(R.drawable.gradient1);
    ...
    public void box9(View view) {
        if(count > 0){
            if(flag == 0){
                iv9.setImageResource(R.drawable.gradient1);
                count --;
                flag = 1;
                c9 = 0;
                ll2.setBackgroundResource(R.drawable.gradient2);
                ...
                iv9.setImageResource(R.drawable.gradient2);
                count --;
                flag = 0;
                c9 = 1;
                ll1.setBackgroundResource(R.drawable.gradient1);
